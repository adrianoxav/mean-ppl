...
export class PreguntaDetailComponent implements OnInit {
  ...
  getPreguntaDetail(id) {
    this.http.get('http://www.aprendizajeactivo.espol.edu.ec:3000/pregunta/'+id, httpOptions).subscribe(data => {
      this.pregunta = data;
      console.log(data);
    });
  }
  ...
  deletePregunta(id) {
    this.http.delete('http://www.aprendizajeactivo.espol.edu.ec:3000/pregunta/'+id, httpOptions)
      .subscribe(res => {
