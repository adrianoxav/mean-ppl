...
cursocreado:any;
 gruposcreados=[];
  ...
  saveCurso() {
    ...
    this.http.post('http://localhost:443/curso', this.curso,httpOptions)
      .subscribe(res => {
        ...
        console.log(res);
          ...
          for(var i=1;i<=Number(nomgrup);i++){
            ...
            console.log(grupo);
            this.http.post('http://localhost:443/grupo', grupo,httpOptions)
              .toPromise().then(res => {
                console.log(res);
  ...
  updategrupos(){
    this.http.put('http://localhost:443/curso/'+this.cursocreado['_id'],this.cursocreado,httpOptions).toPromise().then(data => {
      console.log(data);
