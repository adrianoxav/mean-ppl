...
cursocreado:any;
 gruposcreados=[];
  ...
  saveCurso() {
    ...
    this.http.post('http://aprendizajeactivo.espol.edu.ec:443/curso', this.curso,httpOptions)
      .subscribe(res => {
        ...
        console.log(res);
          ...
          for(var i=1;i<=Number(nomgrup);i++){
            ...
            console.log(grupo);
            this.http.post('http://aprendizajeactivo.espol.edu.ec:443/grupo', grupo,httpOptions)
              .toPromise().then(res => {
                console.log(res);
  ...
  updategrupos(){
    this.http.put('http://aprendizajeactivo.espol.edu.ec:443/curso/'+this.cursocreado['_id'],this.cursocreado,httpOptions).toPromise().then(data => {
      console.log(data);
