...
export class CuestionarioEditComponent implements OnInit {
    ...
    getCuestionario(id) {
      this.http.get('http://www.ppl.espol.edu.ec:443/cuestionario/'+id).subscribe(data => {
    ...
    updateCuestionario(id) {
      ...
      this.http.put('http://www.ppl.espol.edu.ec:443/cuestionario/'+id, this.cuestionario,httpOptions)
        .subscribe(res => {
            let id = res['_id'];
