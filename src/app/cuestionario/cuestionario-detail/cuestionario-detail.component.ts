...
export class CuestionarioDetailComponent implements OnInit {
    ...
    getCuestionarioDetail(id) {
      ...
      this.http.get('http://aprendizajeactivo.espol.edu.ec:443/cuestionario/'+id,httpOptions).subscribe(data => {
  ...
  //    this.getPreguntas(this.cuestionario.preguntas);
    ...
    deleteCuestionario(id) {
      this.http.delete('http://aprendizajeactivo.espol.edu.ec:443/cuestionario/'+id,httpOptions)
        .subscribe(res => {
