...
this.http.post('http://www.aprendizajeactivo.espol.edu.ec:3000/api/signup',this.signupData).subscribe(resp => {
  console.log(resp);
  res=resp;
  let idUser = resp['_id'];
  ...
  if(res.msg=="email already exists."){
    ...
    this.http.get('http://www.aprendizajeactivo.espol.edu.ec:3000/users/email/'+this.signupData.email).subscribe(data => {
